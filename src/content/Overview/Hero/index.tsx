            ...
            >
                <Grid item md={10} lg={8} mx="auto">
                    ...
                    <TypographyH2
                        ...
                        fontWeight="normal"
                    >
                        High performance React template built with lots of
                    ...
                    <Grid container spacing={3} mt={5}>
                        <Grid item md={4}>
                            ...
                            <Typography variant="h4">
                                ...
                                <Typography
                                    ...
                                    variant="subtitle2"
                                >
                                    A simple and customizable component library
                                    to build faster, beautiful, and accessible
                                    React apps.
                                </Typography>
                            </Typography>
                        </Grid>
                        <Grid item md={4}>
                            <NextJsAvatar>
                                <img
                                    src="/static/images/logo/next-js.svg"
                                    alt="NextJS"
                                />
                            </NextJsAvatar>
                            <Typography variant="h4">
                                ...
                                <Typography
                                    ...
                                    variant="subtitle2"
                                >
                                    Next.js gives you the best developer
                                    experience with all the features you need
                                    for production.
                                </Typography>
                            </Typography>
                        </Grid>
                        <Grid item md={4}>
                            ...
                            <Typography variant="h4">
                                ...
                                <Typography
                                    ...
                                    variant="subtitle2"
                                >
                                    Tokyo Free White features a modern
                                    technology stack and is built with React +
                                    Typescript.
                                </Typography>
                            </Typography>
                        </Grid>
